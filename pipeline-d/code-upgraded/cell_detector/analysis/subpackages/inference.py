...
def inference(network):
    ...
    with tf.name_scope('Convolution_1'):
        ...
        out_ch_dim = 30
        conv1 = convolution2d_full(network.images, in_ch_dim, out_ch_dim, False, LayerID + '_Convolution_1', 2)
    ...
    with tf.name_scope('Dropout'):
        r_Fconv1Dout = tf.nn.dropout(r_Fconv1, 0.2)
    ...
    with tf.name_scope('Dropout'):
        r_Fconv2Dout = tf.nn.dropout(r_Fconv2, 0.2)
